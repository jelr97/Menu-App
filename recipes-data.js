const STARTER_RECIPES = [
  ...
  {
    id: "hummus-veggies",
    name: { en: "Hummus & Veggies", es: "Hummus con Vegetales" },
    category: "snack",
    servings: 4,
    prepTime: 10,
    cookTime: 0,
    ingredients: [
      { name: { en: "canned chickpeas", es: "garbanzos enlatados" }, amount: 400, unit: "g" },
      { name: { en: "tahini", es: "tahini" }, amount: 3, unit: "tbsp" },
      { name: { en: "lemon juice", es: "jugo de limón" }, amount: 2, unit: "tbsp" },
      { name: { en: "garlic cloves", es: "dientes de ajo" }, amount: 2, unit: "units" },
      { name: { en: "olive oil", es: "aceite de oliva" }, amount: 2, unit: "tbsp" },
      { name: { en: "carrots", es: "zanahorias" }, amount: 2, unit: "units" },
      { name: { en: "celery stalks", es: "tallos de apio" }, amount: 3, unit: "units" },
      { name: { en: "cucumber", es: "pepino" }, amount: 1, unit: "units" }
    ],
    instructions: {
      en: [
        "Drain and rinse chickpeas. Add to food processor with tahini, lemon juice, garlic, and olive oil.",
        "Blend until smooth, scraping sides as needed. Add 2-3 tbsp water if too thick.",
      ...
      es: [
        "Escurre y enjuaga los garbanzos. Agrega al procesador con tahini, jugo de limón, ajo y aceite de oliva.",
        "Licúa hasta que quede suave, raspando los lados según sea necesario. Agrega 2-3 cdas de agua si queda muy espeso.",
        "Sazona con sal y una pizca de comino.",
        "Corta las zanahorias, apio y pepino en palitos.",
        "Sirve el hummus en un bowl con los palitos de verduras para mojar."
      ]
    },
    isCustom: false
  },
  {
    id: "yogurt-parfait",
    name: { en: "Yogurt Parfait", es: "Parfait de Yogur" },
    category: "snack",
    servings: 2,
    prepTime: 5,
    cookTime: 0,
    ingredients: [
      { name: { en: "Greek yogurt", es: "yogur griego" }, amount: 300, unit: "g" },
      { name: { en: "granola", es: "granola" }, amount: 80, unit: "g" },
      { name: { en: "honey", es: "miel" }, amount: 2, unit: "tbsp" },
      { name: { en: "fresh berries", es: "frutos rojos frescos" }, amount: 100, unit: "g" },
      { name: { en: "banana", es: "banano" }, amount: 1, unit: "units" }
    ],
    instructions: {
      en: [
        "Slice banana into rounds.",
        "In a glass or bowl, layer: yogurt, granola, berries, banana.",
        "Repeat layers until glass is full.",
        "Drizzle honey on top. Serve immediately."
      ],
      es: [
        "Corta el banano en rodajas.",
        "En un vaso o bowl, haz capas: yogur, granola, frutos rojos, banano.",
        "Repite las capas hasta llenar el vaso.",
        "Rocía miel encima. Sirve inmediatamente."
      ]
    },
    isCustom: false
  },
  {
    id: "trail-mix",
    name: { en: "Trail Mix", es: "Mix de Frutos Secos" },
    category: "snack",
    servings: 6,
    prepTime: 5,
    cookTime: 0,
    ingredients: [
      { name: { en: "almonds", es: "almendras" }, amount: 100, unit: "g" },
      { name: { en: "cashews", es: "marañones" }, amount: 80, unit: "g" },
      { name: { en: "raisins", es: "pasas" }, amount: 60, unit: "g" },
      { name: { en: "dark chocolate chips", es: "chips de chocolate oscuro" }, amount: 60, unit: "g" },
      { name: { en: "dried cranberries", es: "arándanos secos" }, amount: 50, unit: "g" },
      { name: { en: "sunflower seeds", es: "semillas de girasol" }, amount: 40, unit: "g" }
    ],
    instructions: {
      en: [
        "Combine all ingredients in a large bowl.",
        "Toss to mix evenly.",
        "Divide into portions or store in an airtight container.",
        "Keeps well for up to 2 weeks."
      ],
      es: [
        "Combina todos los ingredientes en un bowl grande.",
        "Mezcla para distribuir uniformemente.",
        "Divide en porciones o guarda en un recipiente hermético.",
        "Se conserva bien hasta por 2 semanas."
      ]
    },
    isCustom: false
  },
  {
    id: "protein-bowl",
    name: { en: "Protein Bowl", es: "Bowl de Proteína" },
    category: "snack",
    servings: 1,
    prepTime: 10,
    cookTime: 0,
    ingredients: [
      { name: { en: "Greek yogurt", es: "yogur griego" }, amount: 200, unit: "g" },
      { name: { en: "protein powder", es: "proteína en polvo" }, amount: 30, unit: "g" },
      { name: { en: "banana", es: "banano" }, amount: 1, unit: "units" },
      { name: { en: "peanut butter", es: "mantequilla de maní" }, amount: 1, unit: "tbsp" },
      { name: { en: "granola", es: "granola" }, amount: 30, unit: "g" },
      { name: { en: "honey", es: "miel" }, amount: 1, unit: "tbsp" }
    ],
    instructions: {
      en: [
        ...
        "Slice banana.",
        "Pour yogurt mixture into a bowl. Top with banana slices, peanut butter, and granola.",
        "Drizzle honey on top."
      ],
      es: [
        "Mezcla el yogur griego con la proteína en polvo hasta que quede suave.",
        "Corta el banano en rodajas.",
        "Vierte la mezcla de yogur en un bowl. Agrega las rodajas de banano, mantequilla de maní y granola.",
        "Rocía miel encima."
      ]
    },
    isCustom: false
